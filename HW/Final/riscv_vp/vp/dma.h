...
struct SimpleDMA : public sc_core::sc_module {
  ...
  sc_core::sc_time dma_start_time;
  ...
  void run() {
    while (true) {
      ...
      transfer_time += sc_core::sc_time_stamp() - dma_start_time;
  ...
  void transport(tlm::tlm_generic_payload &trans, sc_core::sc_time &delay) {
    ...
    if ((cmd == tlm::TLM_WRITE_COMMAND) && (addr == OP_ADDR)) {
      dma_start_time = sc_core::sc_time_stamp();
      run_event.notify(sc_core::sc_time(20, sc_core::SC_NS));
    }
