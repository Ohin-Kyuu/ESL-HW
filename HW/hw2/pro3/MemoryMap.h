...
// Median and Scharr Filter Memory Map
// Used between SimpleBus & Target Filter
const int MOD_MM_BASE = 0x90000000;
const int MOD_MM_SIZE = 0x000000FF;
const int MOD_MM_MASK = 0x000000FF;
